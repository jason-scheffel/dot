...
- You may also view the aforementioned files and directories at
  <https://sr.ht/~jason-scheffel/dot/>.
...
[`dot.py -h`](/dot/help/dot.py.txt)

[`dot.py add -h`](/dot/help/dot.py-add.txt)

[`dot.py remove -h`](/dot/help/dot.py-remove.txt)

[`dot.py ignore -h`](/dot/help/dot.py-ignore.txt)

[`dot.py install -h`](/dot/help/dot.py-install.txt)

[`dot.py sync -h`](/dot/help/dot.py-sync.txt)

[`dot.py init -h`](/dot/help/dot.py-init.txt)
